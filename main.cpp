...
int main() {
    ...
    window.displayImagesWithTransition("texture/intro1.png", "texture/intro2.png", "texture/intro3.png","texture/menu.png", 400,200); // we strt by displaying a small intro
