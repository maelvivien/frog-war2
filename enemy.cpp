...
Enemy::Enemy(SDL_Renderer* renderer, const std::string& name, const std::string& image_path, int x, int y, int width, int height, int frameWidth, int frameHeight, int numFrames, int numColumns)
{
    _renderer = renderer;
    _name = name;
    _x = x;
...
std::vector<Entity*>* Enemy::_collisionvector = nullptr;

void Enemy::setCollisionVector(std::vector<Entity*>* collisionvector) {
    _collisionvector = collisionvector;
}


Enemy::Enemy(SDL_Renderer* renderer, int x, int y, int width, int height) {
    _renderer = renderer;
    _name = "";
    _x = x;
    _y = y;
...
void Enemy::animate(int row, bool flip) {
...
bool Enemy::test_collide(Entity* test, int dx, int dy){
